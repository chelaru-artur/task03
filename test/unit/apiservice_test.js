describe('Unit: apiService', function() {
  ...
  beforeEach(module('app'));
	  ...
	  beforeEach(inject(function(_apiService_, _$http_ , $injector){
	  	...
	  	$httpBackend.when('JSONP','http://api.rottentomatoes.com/api/public/v1.0/movies.json?apikey=wvnw24xfn5msywmrbv4c59v5&callback=JSON_CALLBACK&page=1&page_limit=30&q=spider')
